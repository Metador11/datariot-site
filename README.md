# <img src="./assets/logo.jpg" width="40" height="40" align="center" style="border-radius: 12px; margin-right: 10px;" /> Datariot — Cognitive Feed & Debate Arena
...
**Datariot** — это высокотехнологичная образовательная платформа и дебатная видео-арена в формате вертикальных видео (TikTok-style). Мы создали этот проект как интеллектуальный хаб нового поколения для ведения структурированных дискуссий и обмена осмысленным контентом. 

> [!NOTE]  
> **Миссия проекта:** Направить естественную привычку скроллинга коротких видео в русло критического мышления, обмена глубокими знаниями и аргументированных дебатов. Побеждает логика и сила фактов, а не хаотичный кликбейт и лайки.

---

## ⚡ Ключевые Архитектурные Фичи

*   **Premium Loop Player & Feed**: Три различных режима ленты (Classic, Mosaic, Pulse) на базе `expo-video` / `expo-av` с бесшовным полноэкранным воспроизведением.
*   **Cognitive Physics Engine**: Ультра-плавный свайп-движок жестов (`react-native-gesture-handler` + `reanimated`), обеспечивающий стабильный 60 FPS интерфейс.
*   **Arena & Battles**: Модуль интеллектуальных дебатов, где пользователи могут записывать видео-аргументы и вызывать друг друга на раунды мнений.
*   **Deep Dive Mode**: Специальный режим детального разбора тем и проверки фактов, позволяющий углубиться в аргументы участников дискуссии.
*   **Glassmorphic Design System**: Премиальная тема оформления с глубоким обсидиановым фоном и динамическими стеклянными размытиями.
...
| **Стейт** | Zustand | Легковесное управление состоянием с нулевым оверхедом |
...
## 🎨 Дизайн-Система: Cyber-Elite Obsidian

Эстетика Datariot построена на глубоких темных оттенках в сочетании с неоновыми голубыми акцентами, создавая ощущение премиального космического пространства.
...
*   [x] Полноэкранный проигрыватель с бесконечным скроллингом видео (Classic/Mosaic).
...
*   [ ] Полнофункциональная дебатная баттл-система (видео-ответы на аргументы).
...
**Datariot** — Учитесь глубоко. Думайте критически. Растите ежедневно. 🧠💡
