            ...
            >
                ...
                <View style={[styles.card, { backgroundColor: theme.colors.surface.card, borderColor: isDark ? 'rgba(255,255,255,0.06)' : 'rgba(0,0,0,0.05)' }]}>
                    <View style={styles.header}>
                        ...
                        <Text style={[styles.title, { color: theme.colors.text.primary }]}>Sign Up</Text>
                        <Text style={[styles.subtitle, { color: theme.colors.text.secondary }]}>Create your account</Text>
                    </View>
                    ...
                    <View style={styles.footer}>
                        <Text style={[styles.footerText, { color: theme.colors.text.secondary }]}>
                            ...
                            <Text
                                ...
                                onPress={() => router.replace('/auth/login-form')}
                            >
                                Sign in
                            </Text>
                        </Text>
